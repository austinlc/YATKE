// $Id: config-FFD.h 5 2011-08-09 02:08:58Z kawano $
/* 
   config.h : 
...
/*----------------------------------------------------------
Energy grid for distributions of excitation energies, etc.
*/
#define HAVE_OUTPUT_ENERGY_GRID
#ifdef HAVE_OUTPUT_ENERGY_GRID
const int NUMBER_OUTPUT_ENERGY_GRID = 201;
#endif
...
const int  EVENT_OUTPUT_FORMAT = 2;
